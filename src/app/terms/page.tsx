...
export const metadata = {
  title: "Terms and Conditions — GoChat Games",
};
    ...
    <div className="min-h-screen bg-[#F6F8FB] px-4 py-10">
      <div className="mx-auto max-w-2xl">
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
          ...
          <p className="mb-6 text-sm text-slate-500">GoChat Games — Etisalat UAE</p>
          ...
          <div className="space-y-5 text-sm leading-relaxed text-slate-600">
            <section>
              ...
              <p>
                GoChat Games is a subscription content service offered to
                Etisalat UAE subscribers. By subscribing, you agree to these
                terms.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                <span className="font-medium text-slate-900">C HGD</span> to{" "}
